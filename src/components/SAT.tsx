    ...
    const enterResults = (
      ...
      setHeatTeams(hTeams.map((t) => {
        const sub0 = round === 0
          ...
          : (heatSubs[`r${round}:${slotIdx}:${t.members[0]}`] || '');
        const sub1 = round === 0
          ? (heatSubs[`${slotIdx}:${t.members[1]}`] || '')
          : (heatSubs[`r${round}:${slotIdx}:${t.members[1]}`] || '');
          ...
          <div style={cHead}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              {day2Teams.length > 0 && d2CompletedCount === 0 && !editingBracket && (
                <button onClick={() => auth.req(() => { setBracketEdits(effectiveD2Heats.map(h => [...h])); setEditingBracket(true); setBracketSel(null); })}
